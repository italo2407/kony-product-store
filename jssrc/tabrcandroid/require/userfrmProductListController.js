define({
    ...
    populateSegment: function(products) {
        ...
        for (var i = 0; i < products.length; i++) {
            var sknPrice = products[i].onSale == "true" ? "sknlblPriceOnSaleTablet" : "sknlblPriceTablet";
            ...
            data[i] = {
                imgProduct: {
                    src: products[i].mediumImage
                },
                lblNameProduct: {
                    text: products[i].name
                },
                lblPrice: {
                    text: "$ " + products[i].salePrice,
                    skin: sknPrice
                },
                lblOnSale: {
                    text: "ON SALE!",
                ...
                lblAvgUserRating: {
                    ...
                    isVisible: isVisibleAvgUserRating
                },
