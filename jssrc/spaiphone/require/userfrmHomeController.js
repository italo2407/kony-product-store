define({
    ...
    animationWidget1: function(topStart, topEnd, opacityStart, opacityEnd, isNeedEndCallback, isVisibleSearchComp) {
        var self = this;
    ...
    animationWidget2: function(topStart, topEnd, opacityStart, opacityEnd, isNeedEndCallback, isVisibleSearchComp) {
        var self = this;
    ...
    animationSearchComponent: function(topStart, topEnd, opacityStart, opacityEnd, isNeedEndCallback, isVisibleSearchComp) {
        var animation = this.animationWidget1(topStart, topEnd, opacityStart, opacityEnd, isNeedEndCallback, isVisibleSearchComp);
    ...
    animationSegmentListCategory: function(topStart, topEnd, opacityStart, opacityEnd, isNeedEndCallback, isVisibleSearchComp) {
        var animation = this.animationWidget2(topStart, topEnd, opacityStart, opacityEnd, isNeedEndCallback, isVisibleSearchComp);
        this.view.sgmCategories.animate(animation.animObj, animation.animConfig, animation.callbacks);
    },
